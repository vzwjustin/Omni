...
from ..errors import CircuitBreakerError, CircuitBreakerOpenError
...
class CircuitBreaker:
    ...
    def _transition_to_open(self) -> None:
        ...
        backoff_multiplier = min(2 ** (self._failure_count - self._config.failure_threshold), 
    ...
    def _transition_to_half_open(self) -> None:
        ...
        self._next_attempt_time = datetime.now() + timedelta(
            seconds=self._config.half_open_timeout
        )
