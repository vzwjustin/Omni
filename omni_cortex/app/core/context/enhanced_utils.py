...
from ..constants import CACHE, MULTI_REPO, TOKEN_BUDGET
...
class CircuitBreakerUtils:
    ...
    @staticmethod
    def should_attempt_recovery(last_failure_time: datetime, recovery_timeout: int) -> bool:
        """
...
class MultiRepoUtils:
    ...
    @staticmethod
    def is_repository_accessible(repo_path: str) -> tuple[bool, str | None]:
        """
