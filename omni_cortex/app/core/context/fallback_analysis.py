...
class EnhancedFallbackAnalyzer:
    ...
    def analyze(self, query: str, code_context: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def _estimate_complexity(self, query: str, code_context: Optional[str]) -> str:
        ...
        high_complexity_indicators = [
            "multiple", "complex", "entire", "system", "architecture",
            "refactor", "migrate", "redesign", "scale",
        ]
        
        low_complexity_indicators = [
            "simple", "quick", "small", "minor", "typo", "fix",
        ]
    ...
    def _generate_potential_blockers(self, task_type: str) -> List[str]:
        ...
        return blockers_map.get(task_type, [
...
class ComponentFallbackMethods:
    ...
    def fallback_file_discovery(
        ...
        extension_scores = {
            ...
            ".py": 0.9, ".js": 0.9, ".ts": 0.9, ".jsx": 0.85, ".tsx": 0.85,
            ".java": 0.85, ".cpp": 0.85, ".c": 0.85, ".go": 0.85, ".rs": 0.85,
            ".rb": 0.8, ".php": 0.8, ".swift": 0.8, ".kt": 0.8,
            
            # Medium relevance - config and data
            ".json": 0.7, ".yaml": 0.7, ".yml": 0.7, ".toml": 0.7,
            ".xml": 0.6, ".ini": 0.6, ".conf": 0.6, ".env": 0.6,
            
            # Lower relevance - documentation
            ".md": 0.5, ".txt": 0.4, ".rst": 0.5,
            
            # Build and dependency files
            "package.json": 0.8, "requirements.txt": 0.8, "Cargo.toml": 0.8,
            "pom.xml": 0.8, "build.gradle": 0.8, "Makefile": 0.7,
        }
        ...
        if file_list:
            ...
            for file_path in file_list[:max_files]:
                ...
                files.append(EnhancedFileContext(
                    path=file_path,
...
_fallback_analyzer: Optional[EnhancedFallbackAnalyzer] = None
