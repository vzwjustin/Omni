...
class ComponentPerformanceMetrics:
    ...
    def update(self, metrics: ComponentMetrics) -> None:
        ...
        self.avg_tokens = self.total_tokens / self.total_executions if self.total_executions > 0 else 0
...
class ContextGatewayMetrics:
    ...
    def get_component_performance_summary(
        self,
        component: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        if component:
            ...
            return {
                ...
                "success_rate": perf.successful_executions / perf.total_executions if perf.total_executions > 0 else 0.0,
                ...
                "cache_hit_rate": perf.cache_hits / (perf.cache_hits + perf.cache_misses) if (perf.cache_hits + perf.cache_misses) > 0 else 0.0,
                "fallback_rate": perf.fallback_uses / perf.total_executions if perf.total_executions > 0 else 0.0,
            }
    ...
    def get_token_usage_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_tokens_per_session": self._total_tokens_used / self._total_sessions if self._total_sessions > 0 else 0,
        }
    ...
    def get_session_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "success_rate": self._successful_sessions / self._total_sessions if self._total_sessions > 0 else 0.0,
        }
    ...
    def cleanup_old_data(self) -> int:
        ...
        self._execution_times = [(ts, duration) for ts, duration in self._execution_times if ts > cutoff]
...
_gateway_metrics: Optional[ContextGatewayMetrics] = None
...
def get_gateway_metrics() -> ContextGatewayMetrics:
    ...
    if _gateway_metrics is None:
        ...
        _gateway_metrics = ContextGatewayMetrics(
