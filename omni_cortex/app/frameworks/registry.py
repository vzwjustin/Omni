...
class FrameworkDefinition:
    ...
    node_function: Optional[str] = None  # Import path to node function (None = use generator)
...
def get_framework_safe(name: str) -> Optional[FrameworkDefinition]:
    """Get a framework by name, returning None if not found."""
    return FRAMEWORKS.get(name)


def get_frameworks_by_category(category: FrameworkCategory) -> List[FrameworkDefinition]:
...
def find_by_vibe(vibe: str) -> Optional[FrameworkDefinition]:
...
def match_vibes(query: str) -> Optional[str]:
    """
