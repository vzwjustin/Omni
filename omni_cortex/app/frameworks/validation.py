...
from .registry import FRAMEWORKS, FrameworkDefinition, FrameworkCategory
...
class FrameworkValidator:
    ...
    def _validate_framework(self, name: str, definition: FrameworkDefinition):
        ...
        valid_task_types = [
            "unknown", "debug", "implement", "refactor", "test", "optimize",
            "architecture", "security", "docs", "planning", "algorithm",
            "adaptive", "context", "api", "compute", "quality", "iterative",
            "agent", "requirements"
        ]
