...
async def _plan_implementation(
    understanding: str, requirements: list[str], code_context: str, state: GraphState
) -> list[str]:
...
async def _execute_action(
    ...
    iteration: int,
    code_context: str,
    previous_actions: list[SWEAction],
    query: str,
    state: GraphState,
) -> SWEAction:
...
async def _validate_implementation(
    actions: list[SWEAction], requirements: list[str], query: str, state: GraphState
) -> tuple[bool, str]:
