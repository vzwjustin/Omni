...
async def _generate_skeleton(query: str, code_context: str, state: GraphState) -> list[SkeletonPoint]:
...
async def _expand_point(point: SkeletonPoint, query: str, code_context: str, state: GraphState) -> str:
...
async def skeleton_of_thought_node(state: GraphState) -> GraphState:
    ...
    add_reasoning_step(state=state, framework="skeleton_of_thought", thought=f"Generated skeleton with {len(skeleton)} points", action="skeleton")
    ...
    add_reasoning_step(state=state, framework="skeleton_of_thought", thought="Expanded all skeleton points in parallel", action="expand")
