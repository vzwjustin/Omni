...
async def _find_analogies(query: str, code_context: str, state: GraphState) -> list[Analogy]:
...
async def _map_analogy(
    analogy: Analogy, query: str, code_context: str, state: GraphState
) -> tuple[str, str, float]:
...
async def _synthesize_solution(
    analogies: list[Analogy], query: str, code_context: str, state: GraphState
) -> str:
...
async def analogical_node(state: GraphState) -> GraphState:
    ...
    for analogy in analogies:
        mapping, adapted, score = await _map_analogy(analogy, query, code_context, state)
