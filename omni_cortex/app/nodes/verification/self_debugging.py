...
async def _verify_fix(fixed_code: str, original_bugs: list[str], query: str, state: GraphState) -> tuple[bool, str]:
...
"""
    ...
    is_clean = "yes" in response.lower() and "no" not in response.split("CLEAN:")[-1].split("\n")[0].lower()
