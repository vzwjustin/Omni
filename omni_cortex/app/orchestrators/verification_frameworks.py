...
async def rarr(sampler: ClientSampler, query: str, context: str) -> dict[str, Any]:
    ...
    return {"final_answer": cited, "metadata": {"framework": "rarr"}}
...
Do they contradict? List any inconsistencies.""",
    ...
    return {"final_answer": patched, "metadata": {"framework": "metaqa", "variants": len(variants)}}
