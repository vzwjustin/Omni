...
class TestEnhancedDocumentationSearcher:
    ...
    async def test_search_with_fallback_web_success(self):
        ...
        with patch.object(searcher, 'search_web_with_attribution', new_callable=AsyncMock) as mock_web:
            with patch.object(searcher, 'search_knowledge_base', new_callable=AsyncMock) as mock_local:
